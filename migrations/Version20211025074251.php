 ...
 */
final class Version20211025074251 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE class_m_lecturer DROP FOREIGN KEY FK_AD98159CC575DBAF');
        $this->addSql('ALTER TABLE student DROP FOREIGN KEY FK_B723AF33F8DB7177');
        $this->addSql('ALTER TABLE class_m_lecturer DROP FOREIGN KEY FK_AD98159CBA2D8762');
